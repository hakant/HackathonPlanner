...
@inject(HttpClient, Router, ProjectService, TooltipService, DialogService)
export class IdeaCardDetail {
    ...
    constructor(http, router, projectService, tooltipService, dialogService) {
                ...
                .then(projects => {
                      ...
                      this.dialogService.open({viewModel: Prompt, model: this.project._id }).then(response => {
                         ...
                         if (!response.wasCancelled) {
                            ...
                            window.history.pushState("string", "Hackathon Planner", "#");
